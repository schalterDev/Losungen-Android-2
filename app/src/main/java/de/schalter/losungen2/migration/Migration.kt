...
class Migration(private val activity: Activity) {
    ...
    private fun migrateSharedPreferences() {
        ...
        val notificationContent = preference.getString(LEGACY_PREF_NOTIFICATION_CONTENT, "0")
    ...
    private fun migrateDatabase() {
        val language = preference.getString(LEGACY_LANGUAGE_VERSEES, "de")!!
    ...
    companion object {
        ...
        private const val LEGACY_LANGUAGE_VERSEES = "selected_language"
    }
}