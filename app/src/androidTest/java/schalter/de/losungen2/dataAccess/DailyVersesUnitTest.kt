...
class DailyVersesUnitTest {
    ...
    fun writeDailyVerseAndRead() {
        ...
        val verseFromDatabase: DailyVerse = dailyVersesDao.findDailyVerseByDate(date)
    ...
    fun writeMultipleDailyVerses() {
        ...
        var verseFromDatabase: DailyVerse = dailyVersesDao.findDailyVerseByDate(date)
        assertThat(verseFromDatabase.newTestamentVerseBible, equalTo(dailyVerse.newTestamentVerseBible))
        assertThat(verseFromDatabase.newTestamentVerseText, equalTo(dailyVerse.newTestamentVerseText))
        assertThat(verseFromDatabase.oldTestamentVerseBible, equalTo(dailyVerse.oldTestamentVerseBible))
        assertThat(verseFromDatabase.oldTestamentVerseText, equalTo(dailyVerse.oldTestamentVerseText))
        ...
        verseFromDatabase = dailyVersesDao.findDailyVerseByDate(dailyVerseNextDay.date)
    ...
    fun updateNotes() {
        ...
        var verseFromDatabase: DailyVerse = dailyVersesDao.findDailyVerseByDate(dailyVerse.date)
        assertThat(verseFromDatabase.notes, isEmptyOrNullString())

        dailyVersesDao.updateNotes(dailyVerse.date, notes)
        verseFromDatabase = dailyVersesDao.findDailyVerseByDate(dailyVerse.date)
    ...
    fun updateLanguage() {
        ...
        val verseFromDatabase: DailyVerse = dailyVersesDao.findDailyVerseByDate(dailyVerseEnglish.date)
    ...
    fun dateConverting() {
        ...
        // find verse
        var verseFromDatabase: DailyVerse = dailyVersesDao.findDailyVerseByDate(calendar.time)
        assertThat(verseFromDatabase.date, equalTo(dailyVerse.date))
